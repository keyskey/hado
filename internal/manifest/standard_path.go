...
// EvidencePlaceholder is written into manifest fields meant to be replaced by humans or charge.
const EvidencePlaceholder = "PLACEHOLDER"

// EvidenceUnset reports whether v is empty or the explicit placeholder (not yet real evidence).
func EvidenceUnset(v string) bool {
	s := strings.TrimSpace(v)
	return s == "" || s == EvidencePlaceholder
}
